...
/*
 * GreenLake Private Cloud VMaaS CMP API
 *
 * GreenLake Private Cloud VMaaS CMP API
 *
 * API version: 1.0.0
 * Contact: glcs.team-avion@hpe.com
...
type InstancesApiCreateAnInstanceOpts struct {
	Body optional.Interface
}

func (a *InstancesApiService) CreateAnInstance(ctx context.Context, serviceInstanceId string, localVarOptionals *InstancesApiCreateAnInstanceOpts) (models.GetInstanceResponse, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/api/v1/vmaas/{service_instance_id}/instances"
...
func (a *InstancesApiService) DeleteAnIstance(ctx context.Context, serviceInstanceId string, instanceId int32, localVarOptionals *InstancesApiDeleteAnIstanceOpts) (*http.Response, error) {
	var (
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/v1/vmaas/{service_instance_id}/instances/{instance_id}"
	localVarPath = strings.Replace(localVarPath, "{"+"service_instance_id"+"}", fmt.Sprintf("%v", serviceInstanceId), -1)
...
@return models.GetInstanceResponse
*/
func (a *InstancesApiService) GetASpecificInstance(ctx context.Context, serviceInstanceId string, instanceId int32) (models.GetInstanceResponse, *http.Response, error) {
	var (
...
func (a *InstancesApiService) GetAllInstances(ctx context.Context, serviceInstanceId string, localVarOptionals *InstancesApiGetAllInstancesOpts) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
func (a *InstancesApiService) GetListOfSnapshotsForAnInstance(ctx context.Context, serviceInstanceId string, instanceId int32) (*http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/v1/vmaas/{service_instance_id}/instances/{instance_id}/snapshots"
	localVarPath = strings.Replace(localVarPath, "{"+"service_instance_id"+"}", fmt.Sprintf("%v", serviceInstanceId), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"instance_id"+"}", fmt.Sprintf("%v", instanceId), -1)
...
func (a *InstancesApiService) LockAnInstance(ctx context.Context, serviceInstanceId string, instanceId int32) (*http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/v1/vmaas/{service_instance_id}/instances/{instance_id}/lock"
	localVarPath = strings.Replace(localVarPath, "{"+"service_instance_id"+"}", fmt.Sprintf("%v", serviceInstanceId), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"instance_id"+"}", fmt.Sprintf("%v", instanceId), -1)
...
func (a *InstancesApiService) ResizeAnInstance(ctx context.Context, serviceInstanceId string, instanceId int32, localVarOptionals *InstancesApiResizeAnInstanceOpts) (models.GetInstanceResponse, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/v1/vmaas/{service_instance_id}/instances/{instance_id}/resize"
	localVarPath = strings.Replace(localVarPath, "{"+"service_instance_id"+"}", fmt.Sprintf("%v", serviceInstanceId), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"instance_id"+"}", fmt.Sprintf("%v", instanceId), -1)
...
func (a *InstancesApiService) RestartAnInstance(ctx context.Context, serviceInstanceId string, instanceId int32) (*http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/v1/vmaas/{service_instance_id}/instances/{instance_id}/restart"
	localVarPath = strings.Replace(localVarPath, "{"+"service_instance_id"+"}", fmt.Sprintf("%v", serviceInstanceId), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"instance_id"+"}", fmt.Sprintf("%v", instanceId), -1)
...
func (a *InstancesApiService) SnapshotAnInstance(ctx context.Context, serviceInstanceId string, instanceId int32, localVarOptionals *InstancesApiSnapshotAnInstanceOpts) (*http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/v1/vmaas/{service_instance_id}/instances/{instance_id}/snapshot"
	localVarPath = strings.Replace(localVarPath, "{"+"service_instance_id"+"}", fmt.Sprintf("%v", serviceInstanceId), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"instance_id"+"}", fmt.Sprintf("%v", instanceId), -1)
...
func (a *InstancesApiService) StartAnInstance(ctx context.Context, serviceInstanceId string, instanceId int32) (*http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/v1/vmaas/{service_instance_id}/instances/{instance_id}/start"
	localVarPath = strings.Replace(localVarPath, "{"+"service_instance_id"+"}", fmt.Sprintf("%v", serviceInstanceId), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"instance_id"+"}", fmt.Sprintf("%v", instanceId), -1)
...
func (a *InstancesApiService) StopAnInstance(ctx context.Context, serviceInstanceId string, instanceId int32) (*http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/v1/vmaas/{service_instance_id}/instances/{instance_id}/stop"
	localVarPath = strings.Replace(localVarPath, "{"+"service_instance_id"+"}", fmt.Sprintf("%v", serviceInstanceId), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"instance_id"+"}", fmt.Sprintf("%v", instanceId), -1)
...
func (a *InstancesApiService) SuspendAnInstance(ctx context.Context, serviceInstanceId string, instanceId int32) (*http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/v1/vmaas/{service_instance_id}/instances/{instance_id}/suspend"
	localVarPath = strings.Replace(localVarPath, "{"+"service_instance_id"+"}", fmt.Sprintf("%v", serviceInstanceId), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"instance_id"+"}", fmt.Sprintf("%v", instanceId), -1)
...
func (a *InstancesApiService) UndoDeleteOfAnInstance(ctx context.Context, serviceInstanceId string, instanceId int32) (models.GetInstanceResponse, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/v1/vmaas/{service_instance_id}/instances/{instance_id}/cancel-removal"
	localVarPath = strings.Replace(localVarPath, "{"+"service_instance_id"+"}", fmt.Sprintf("%v", serviceInstanceId), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"instance_id"+"}", fmt.Sprintf("%v", instanceId), -1)
...
func (a *InstancesApiService) UnlockAnInstance(ctx context.Context, serviceInstanceId string, instanceId int32) (*http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/v1/vmaas/{service_instance_id}/instances/{instance_id}/unlock"
	localVarPath = strings.Replace(localVarPath, "{"+"service_instance_id"+"}", fmt.Sprintf("%v", serviceInstanceId), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"instance_id"+"}", fmt.Sprintf("%v", instanceId), -1)
...
func (a *InstancesApiService) CloneAnInstance(ctx context.Context, serviceInstanceId string, instanceId int32, localVarOptionals *InstancesApiCloneAnInstanceOpts) (*http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/v1/vmaas/{service_instance_id}/instances/{instance_id}/clone"
	localVarPath = strings.Replace(localVarPath, "{"+"service_instance_id"+"}", fmt.Sprintf("%v", serviceInstanceId), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"instance_id"+"}", fmt.Sprintf("%v", instanceId), -1)
...
func (a *InstancesApiService) CloneToImage(ctx context.Context, serviceInstanceId string, instanceId int32, localVarOptionals *InstancesApiCloneToImageOpts) (*http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/v1/vmaas/{service_instance_id}/instances/{instance_id}/clone-image"
	localVarPath = strings.Replace(localVarPath, "{"+"service_instance_id"+"}", fmt.Sprintf("%v", serviceInstanceId), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"instance_id"+"}", fmt.Sprintf("%v", instanceId), -1)
